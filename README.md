...
| **🔄 마스터 시트 업데이트** | 구글 시트의 최신 데이터를 가져옵니다. ▼ 클릭 시 업데이트 이력을 확인할 수 있습니다 |
...
| 선행지표 | 시트 행번호 | 읽는 컬럼 |
|----------|------------|-----------|
| 본강의 (선행지표1) | **6행** | Q(17): 유입, R(18): 오픈알림자수, S(19): 오픈알림전환율, U(21): 구매전환율, T(20): 구매 |
...
```javascript
var KPI_COL_MAP = [17, 18, 19, 21, 20]; // Q, R, S, U, T 컬럼
```
